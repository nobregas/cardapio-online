...
const TopNavbar: React.FC<TopNavbarProps> = ({ toggleSidebar }) => {
  ...
  return (
    <div className="bg-white py-4 px-5 flex justify-between items-center shadow-sm">
      <button onClick={toggleSidebar} className="text-2xl text-gray-800 bg-transparent border-none cursor-pointer">
      ...
      <div className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
            <Link to="/perfil" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Perfil</Link>
            <Link to="/configuracoes" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Configurações</Link>
            <button 
